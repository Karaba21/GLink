                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div className="relative bg-gradient-to-br from-green-600 via-green-700 to-green-800 p-8 md:p-12 flex flex-col justify-center items-center text-white overflow-hidden">
                            ...
                            <div className="relative z-10 text-center space-y-6">
                                ...
                                <h2 className="text-3xl md:text-4xl font-bold">Bienvenido</h2>
                        ...
                        <div className="p-8 md:p-12">
                            <h3 className="text-2xl md:text-3xl font-bold text-gray-100 mb-2">Iniciar Sesión</h3>
                            <p className="text-gray-300 mb-8">Ingresa tus credenciales</p>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <p className="text-center text-sm text-gray-300">
                                    ¿No tienes cuenta?{' '}
                                    <Link href="/registrate" className="text-green-400 font-semibold hover:text-green-300">
                                        Regístrate aquí
                                    </Link>
                                </p>
                            </form>
